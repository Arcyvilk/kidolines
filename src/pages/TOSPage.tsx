  ...
  return (
    <>
      ...
      <Section column>
        ...
        <h5 style={{ textAlign: 'center' }}>Last updated: 2021-05-01</h5>
        <h3>1. Introduction</h3>
        <P>Welcome to PowerWizz d.o.o. (“Company”, “we”, “our”, “us”)!</P>
        <P>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at kidolines.com (together or individually
          “Service”) operated by PowerWizz d.o.o..
        </P>
        <P>
        ...
        <P>
          ...
          info@kidolines.com so we can try to find a solution. These Terms apply
        ...
        <h3>5. Refunds</h3>
        <P>
          We issue refunds for Contracts within 0 days of the original purchase
          of the Contract.
        </P>
        <h3>6. Content</h3>
        <P>
        ...
        <P>
          PowerWizz d.o.o. has the right but not the obligation to monitor and
          edit all Content provided by users.
        </P>
        <P>
          In addition, Content found on or through this Service are the property
          of PowerWizz d.o.o. or used with permission. You may not distribute,
        ...
        <P>
          ...
          property of PowerWizz d.o.o. and its licensors. Service is protected
          ...
          without the prior written consent of PowerWizz d.o.o..
        </P>
        ...
        <P>
          ...
          to info@kidolines.com, with the subject line: “Copyright Infringement”
        ...
        <h3>12. DMCA Notice and Procedure for Copyright Infringement Claims</h3>
        <P>
        ...
        <P>
          You may provide us either directly at info@kidolines.com or via third
        ...
        <P>
          ...
          that are not owned or controlled by PowerWizz d.o.o..
        </P>
        <P>
          PowerWizz d.o.o. has no control over, and assumes no responsibility
        ...
        <P>
          ...
          laws of Serbia, which governing law applies to agreement without
